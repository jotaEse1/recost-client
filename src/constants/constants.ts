export enum Urls {
    REGISTER = 'https://recost-server.onrender.com/api/authentication/signin',
    LOGIN = 'https://recost-server.onrender.com/api/authentication/login',
    LOGOUT = 'https://recost-server.onrender.com/api/authentication/logout',
